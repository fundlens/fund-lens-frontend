...
import { useCommittee, useCommitteeStats, useContributorsByCommittee, useContributorEntityTypes, useContributorStates } from '../hooks/useApi'
...
export default function CommitteeDetailPage() {
  ...
  const id = parseInt(committeeId || '0', 10)
  ...
  const { data: committee, isLoading: committeeLoading, error: committeeError } = useCommittee(id)
  ...
  usePageTitle(`${committee?.name || 'Committee Details'}`)
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <p className="text-red-800">Error loading committee details.</p>
        </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
        <div className="border-b pb-6 mb-6">
          ...
          <div className="flex gap-2 flex-wrap mb-4">
            ...
            {committee.party && (
              <span className={`px-4 py-2 rounded-full text-sm font-medium ${getPartyColor(committee.party)}`}>
                {committee.party}
              </span>
            )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-1">FEC Committee ID</h3>
            <p className="text-gray-900">{committee.fec_committee_id || 'N/A'}</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-1">State Committee ID</h3>
            <p className="text-gray-900">{committee.state_committee_id || 'N/A'}</p>
          </div>
          {committee.candidate_id && committee.candidate && (
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-1">Associated Candidate</h3>
              <Link
                to={`/candidates/${committee.candidate.id}`}
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Committee Statistics</h2>
        {statsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-blue-50 rounded-lg p-6">
              <h3 className="text-sm font-medium text-blue-800 mb-2">Total Received</h3>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              ...
              <p className="text-3xl font-bold text-green-900">
                {formatNumber(stats.total_contributions_received)}
              </p>
            </div>
