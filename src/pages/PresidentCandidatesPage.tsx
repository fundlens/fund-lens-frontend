...
export default function PresidentCandidatesPage() {
  ...
  usePageTitle(`U.S. President - ${stateCode}`)
  ...
  // Fetch Presidential candidates with stats
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Presidential candidates...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900">
            {stateName} U.S. Presidential Candidates
          </h1>
        </div>
      ...
      {displayedCandidates && displayedCandidates.length > 0 && (
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-4">
            Top Fundraisers - U.S. President - {stateName}
          </h2>
      ...
      {displayedCandidates && displayedCandidates.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-600">No Presidential candidates found with fundraising data.</p>
        </div>
      )}
    </div>
  )
